...
const ErrorMessage = ({ message, onDismiss, className = '' }) => {
  ...
  return (
    <div className={`flex items-start gap-3 p-4 rounded-lg bg-red-50 border border-red-200 ${className}`} role="alert">
...
export const SuccessMessage = ({ message, onDismiss, className = '' }) => {
  if (!message) return null;
  return (
    <div className={`flex items-start gap-3 p-4 rounded-lg bg-green-50 border border-green-200 ${className}`} role="alert">
