  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-white border-r border-gray-200">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200">
        ...
        <div>
          <h1 className="text-sm font-bold text-gray-900">CMS Admin</h1>
          <p className="text-xs text-gray-400">Headless CMS</p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <div className="pt-2">
          <p className="px-3 py-1.5 text-xs font-semibold text-gray-400 uppercase tracking-wider">Content</p>
          <NavLink
            to="/pages/create"
            onClick={onClose}
            className={({ isActive }) =>
